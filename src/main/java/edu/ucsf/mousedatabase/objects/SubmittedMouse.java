...
//  public static final String OtherInstitutionImport = "Other Institution Import";
    ...
    public boolean hasOtherHolderName() {
        return holderName != null && holderName.equalsIgnoreCase("Other(specify)");
    }

    ;

    public boolean hasOtherFacilityName() {
        return holderFacility != null && holderFacility.equalsIgnoreCase("Other(specify)");
    }

    ;

    public boolean isMA() {
        return mouseType != null && mouseType.equalsIgnoreCase("Mutant Allele");
    }

    public boolean isTG() {
        return mouseType != null && (mouseType.equalsIgnoreCase("Transgene") || (mouseType.equalsIgnoreCase("Transgenic")));
    }

    public boolean isIS() {
        return mouseType != null && mouseType.equalsIgnoreCase("Inbred Strain");
    }
    ...
    public boolean isRandomInsertion() {
        return transgenicType != null && transgenicType.equalsIgnoreCase("Random insertion");
    }

    public boolean isPublished() {
        return isPublished != null && isPublished.equalsIgnoreCase("Yes");
    }

    public boolean isCryoOnly() {
        return cryoLiveStatus != null && cryoLiveStatus.equalsIgnoreCase("Cryo only");
    }

    ;

    public boolean hasType() {
        return mouseType != null;
    }

    public boolean isManualFormSubmission() {
        return submissionSource.equals(SubmissionFormSource);
    }
    ...
    public MouseRecord toMouseRecord() {
        ...
        if (producedInLabOfHolder != null && producedInLabOfHolder.equalsIgnoreCase("Yes")) {
            if (r.getGeneralComment() != null) {
                r.setGeneralComment(r.getGeneralComment() + "\nProduced onsite (" + holderName + ").");
            } else {
                r.setGeneralComment("Produced onsite (" + holderName + ").");
    ...
    public MouseRecord toRatRecord() {
        ...
        if (producedInLabOfHolder != null && producedInLabOfHolder.equalsIgnoreCase("Yes")) {
            r.setGeneralComment(r.getGeneralComment() + "  <br>Produced in laboratory of holder (" + holderName + ")");
        }
