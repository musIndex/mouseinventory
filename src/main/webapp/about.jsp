...
<div class="category" style="position: relative;width: 100%;overflow-y: hidden">
    ...
    <div class="site_container" style="position: absolute;top: 15%;width:100%;margin: 0px 0px !important;">
        ...
        <div class="two_column_right" style="padding-right:40px">
            ...
            <p class="homepage_text_bold">Welcome to the MSU Rodent Database.</p>
            <p class="homepage_text">Find Mutant Alleles, Transgenes, and Inbred Strains housed on campus and research with other investigators.</p>
        </div>
    </div>
