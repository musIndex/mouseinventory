...
<div class='site_container'>
  ...
  <% if (template != null){ %>
     ...
     <dd>{{submission.holderName}} <i>Only for manual submissions</i></dd>
     <dd>{{submission.holderFacility}} <i>Only for manual submissions</i></dd>
     ...
     <dd>{{submission.properties['Recipient PI Firstname']}} <i>Only for autogenerated submissions</i></dd>
     <dd>{{submission.properties['Recipient PI Lastname']}} <i>Only for autogenerated submissions</i></dd>
     <dd>{{submission.properties['Recipient Facility']}} <i>Only for autogenerated submissions</i></dd>
     <dd>{{submission.properties['Purchaser']}}</dd>
     <dd>{{submission.properties['Purchaser email']}}</dd>
     <dd>{{submission.properties['Recipient']}}</dd>
     <dd>{{submission.properties['Recipient Email']}}</dd>
