...
# Generation Time: 2019-10-22 20:52:07 +0000
# ************************************************************
...
INSERT INTO `changerequest` (`id`, `mouse_id`, `firstname`, `lastname`, `email`, `status`, `user_comment`, `admin_comment`, `requestdate`, `lastadmindate`, `properties`, `facility_id`, `facility_name`, `holder_email`, `holder_name`, `holder_id`, `action_requested`, `request_source`, `cryo_live_status`, `genetic_background_info`)
VALUES
	(1,2,'estelle','wall','adminDB@ucsf.edu','done','','','2019-09-10','2019-09-10','',4,'','','',2,2,'Change request form','Live only',''),
	(2,4,'','','','pending','Auto-generated change request\nNew Holder Email: jbush@ucsf.edu\nRecipient lasntame: \ndueDateRaw: Mon Oct 07 01:12:13 PDT 2019\nDue Date: Monday, October 07\nRecipient email: \nRecipient: \nRecipient firstname: \nOriginal holder: Adriane Joo\n','','2019-09-23','2019-09-23','New Holder Email=jbush@ucsf.edu	Recipient lasntame=	dueDateRaw=Mon Oct 07 01:12:13 PDT 2019	Due Date=Monday, October 07	Recipient email=	Recipient=	Recipient firstname=	Original holder=Adriane Joo	',4,'','','',2,1,'Transfer Data Upload (TDU) Transfer Report','',''),
	(3,1,'','','','pending','Auto-generated change request\nNew Holder Email: dlaird@ucsf.edu\nRecipient lasntame: \ndueDateRaw: Mon Oct 07 01:12:13 PDT 2019\nDue Date: Monday, October 07\nRecipient email: \nRecipient: \nRecipient firstname: \nOriginal holder: Jeff Bush\n','','2019-09-23','2019-09-23','New Holder Email=dlaird@ucsf.edu	Recipient lasntame=	dueDateRaw=Mon Oct 07 01:12:13 PDT 2019	Due Date=Monday, October 07	Recipient email=	Recipient=	Recipient firstname=	Original holder=Jeff Bush	',2,'','','',3,1,'Transfer Data Upload (TDU) Transfer Report','',''),
	(4,5,'','','','pending','Auto-generated change request\nNew Holder Email: ajoo@ucsf.edu\nRecipient lasntame: \ndueDateRaw: Mon Oct 07 01:12:13 PDT 2019\nDue Date: Monday, October 07\nRecipient email: \nRecipient: \nRecipient firstname: \nOriginal holder: Diana Laird\n','','2019-09-23','2019-09-23','New Holder Email=ajoo@ucsf.edu	Recipient lasntame=	dueDateRaw=Mon Oct 07 01:12:13 PDT 2019	Due Date=Monday, October 07	Recipient email=	Recipient=	Recipient firstname=	Original holder=Diana Laird	',3,'','','',4,1,'Transfer Data Upload (TDU) Transfer Report','',''),
	(6,6,'Estelle','Wall','ewall@ucsf.edu','new','','','2019-09-23',NULL,'',4,'','','',2,5,'Change request form','Cryo only',''),
	(7,1,'Estelle','Wall','ewall@ucsf.edu','new','','','2019-09-23',NULL,'',2,'','','',5,2,'Change request form','Live only',''),
	(9,3,'Jeff ','Bush','jbush@ucsf.edu','new','','','2019-10-17',NULL,'',4,'','','',2,5,'Change request form','Cryo only','');
...
# Dump of table mouseFiles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `mouseFiles`;

CREATE TABLE `mouseFiles` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `mouseFiles` WRITE;
/*!40000 ALTER TABLE `mouseFiles` DISABLE KEYS */;

INSERT INTO `mouseFiles` (`ID`, `filename`, `file`, `mouseID`)
VALUES
...
/*!40000 ALTER TABLE `mouseFiles` ENABLE KEYS */;
UNLOCK TABLES;
